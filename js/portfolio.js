const copy = {
  it: {
    ...
    section_contact: 'Contatti', contact_title: 'Restiamo in contatto.', contact_lead: 'Confronto tecnico, networking e feedback sulle mie app.', location: 'Roma, Italia', classic_version: 'Versione classica'
  },
  en: {
    title: 'Giovanni Trenta — Mobile Architect & Software Engineer',
    ...
    section_contact: 'Contact', contact_title: 'Let’s stay in touch.', contact_lead: 'Technical exchange, networking, and feedback on my apps.', location: 'Rome, Italy', classic_version: 'Classic version'
  }
};
...
function initLanguage() {
  ...
  const preferred = params.get('lang') || localStorage.getItem(languageKey) || (navigator.language.startsWith('it') ? 'it' : 'en');
